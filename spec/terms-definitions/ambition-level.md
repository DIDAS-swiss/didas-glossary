[[def: ambition level, ambition levels, AN1, AN2, AN3, Ambitionsniveau, niveau d'ambition, livello di ambizione]]

~ One of three levels of scope defined for the Swiss e-ID trust infrastructure, describing which [[ref: credential]]s the infrastructure carries and who may issue them.

~ **AN1** covers the e-ID only.

~ **AN2** adds other authoritative public issuer credentials, from federal, cantonal or municipal authorities.
...
~ Relation to ToIP: no equivalent term. Not to be confused with [[xref: toip-glossary, assurance-level]], which is a level of confidence in a claim.

~ Language equivalents:

~ [DE] **Ambitionsniveau**

~ [FR] **niveau d'ambition** *(proposed — the official French version of the Zielbild paper should decide this)*

~ [IT] **livello di ambizione** *(proposed — the official Italian version should decide this)*
