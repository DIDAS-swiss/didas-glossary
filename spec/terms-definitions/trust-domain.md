[[def: trust domain, trust domains, trust space, trust spaces, Vertrauensraum, Vertrauensräume, espace de confiance, spazio di fiducia]]

~ A scope defined by [[ref: governance]] within which actors reliably recognise and accept one another via the [[ref: trust infrastructure]] (human trust and technical trust). Multiple trust domains can coexist on the same trust infrastructure — sectoral, federal or international — each with its own governance, its own acceptance rules and, where applicable, its own trust statements.
